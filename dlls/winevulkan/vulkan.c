        ...
        const VkPhysicalDeviceImageFormatInfo2 *format_info, VkImageFormatProperties2 *properties)
{
    ...
    res = p_vkGetPhysicalDeviceImageFormatProperties2(phys_dev->obj.host.physical_device,
                                                        ...
                                                        VkImageFormatProperties2 *properties)
{
    ...
    return wine_vk_get_physical_device_image_format_properties_2(phys_dev,
            phys_dev->obj.instance->p_vkGetPhysicalDeviceImageFormatProperties2,
            format_info, properties);
}
                                                           ...
                                                           VkImageFormatProperties2 *properties)
{
    ...
    return wine_vk_get_physical_device_image_format_properties_2(phys_dev,
            phys_dev->obj.instance->p_vkGetPhysicalDeviceImageFormatProperties2KHR,
            format_info, properties);
}
                            ...
                            const VkAllocationCallbacks *allocator, VkImage *image)
{
    ...
    return device->obj.p_vkCreateImage(device->obj.host.device, &info, NULL, image);
}
        ...
        const VkAllocationCallbacks *allocator, VkSemaphore *semaphore, void *win_create_info)
{
    ...
    return device->obj.p_vkCreateSemaphore(device->obj.host.device, create_info, NULL, semaphore);
}
        ...
        HANDLE *handle)
{
    ...
    res = device->obj.p_vkGetSemaphoreFdKHR(device->obj.host.device, &fd_info, &fd);
        ...
        const VkImportSemaphoreWin32HandleInfoKHR *handle_info)
{
    ...
    if ((res = device->obj.p_vkImportSemaphoreFdKHR(device->obj.host.device, &fd_info)) != VK_SUCCESS)
        close(fd);
